...
class ProposalPlanListScreen
    extends MineBaseListScreen<ProposalPlanModel, ProposalPlanListCubit> {
  ProposalPlanListScreen({
    super.key,
  }) : super(
          title: 'Danh sách đề án',
          searchPlaceholder: 'Tìm kiếm theo mã hoặc tên đề án',
          buildItem: _buildItem,
          createCubit: (context) => ProposalPlanListCubit(injector.get()),
        );
